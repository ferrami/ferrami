...
const myProfile = {
  ...
  architectures: ["MERN Stack", "Microservices", "RESTful APIs", "Azure", "WordPress", "CMS"],
};
```
<!---
<p align="center"> I'm always learning by working on web projects. I'm getting really good at using MERN Stack: JavaScript: MongoDB, Express, React and Node.js.</p>
